...
public class DrawingApp extends JFrame {
    ...
    public DrawingApp() {
        ...
        DefaultListModel<Layer> layerListModel = new DefaultListModel<>();
        layerListModel.addElement(drawingPanel.getLayers().get(0));
        JList<Layer> layerJList = new JList<>(layerListModel);
    ...
    private JToolBar createToolBar() {
        ...
        btnCursor.addActionListener(e -> setCurrentShapeType(ShapeType.CURSOR));
