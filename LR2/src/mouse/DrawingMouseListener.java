...
public class DrawingMouseListener extends MouseAdapter {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (type == null && app.getActivePlugin() != null) {
            AbstractShape s = app.getActivePlugin().createShape(p, p, parameters);
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (app.getCurrentShapeType() == ShapeType.CURSOR) {
            ...
            if (t == ShapeType.LINE || t == ShapeType.RECTANGLE || t == ShapeType.ELLIPSE || t == null) {
                finishDrawing();
            }
        }
    }
    ...
    private void updatePreview(Point p) {
        AbstractShape current = panel.getCurrentShape();
